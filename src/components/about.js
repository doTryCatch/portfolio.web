...
function About() {
  return (
   <div className="about font-sans font-medium space-y-4">
    ...
    <div className="container-box center color2 rounded-xl">
        <div className="box w-[90%] mb-5 space-y-2 text-gray-400">
            <div className=" center h-16">
            <img src={Mobile} alt="" className='w-12 h-12'/>
            </div>
            <div className="head text-center">
            <h1 className='text-gray-200 text-[16px]'> Web Development</h1>
            </div>
            <div className="discriptions text-center ">
            <p>something for the discription and all incuding some information</p>
            </div>
